...
// Tạo điểm danh mới
router.post('/', auth, roleCheck(['tutor', 'staff']), attendanceController.createAttendance);
...
// Cập nhật điểm danh
router.put('/:id', auth, roleCheck(['tutor', 'staff']), attendanceController.updateAttendance);

// Xóa điểm danh
router.delete('/:id', auth, roleCheck(['tutor', 'staff']), attendanceController.deleteAttendance);

// Điểm danh hàng loạt
router.post('/bulk', auth, roleCheck(['tutor', 'staff']), attendanceController.bulkAttendance);
